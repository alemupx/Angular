...
@Component({
  selector: 'alimentador-tajetas',
  templateUrl: './alimentador-tajetas.component.html',
  styleUrls: ['./alimentador-tajetas.component.css']
})

export class AlimentadorTajetasComponent {
